...
import administrative_uploaders from './admin/uploaders.routes.js'

// user routes
import user_history from './user/history.routes.js'
...
routes.use('/admin', administrative_contents, administrative_users, administrative_uploaders)
routes.use('/user', user_history, user_profile, user_votes, user_comments)
